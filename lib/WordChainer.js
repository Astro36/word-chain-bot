...
exports.Rule = exports.InsaneLevel = exports.HardLevel = exports.NormalLevel = exports.EasyLevel = exports.Level = exports.UsedWordException = exports.NotFoundWordException = exports.InvalidWordException = exports.ForbiddenWordException = exports.WordException = exports.LearningAI = exports.Utils = exports.DictionaryAnalyzer = exports.Dictionary = exports.WordChainer = undefined;
...
var WordChainer = function () {
  function WordChainer(level) {
    ...
    this.dictionary = _Dictionary2.default.getInstance(rules);
      ...
      if (history.length === 0 && !(word[word.length - 1] in dictionaryObj)) {
        ...
        if (lastWord[lastWord.length - 1] !== word[0]) {
          ...
          if (rules.indexOf(_Rule2.default.ALLOWED_INITIAL) !== -1) {
            if (_Utils2.default.convertInitialSound(lastWord[lastWord.length - 1]) !== word[0]) {
              throw new _InvalidWordException2.default();
            }
          } else {
            throw new _InvalidWordException2.default();
          ...
          for (var i in dictionaryObj) {
            ...
            if (history.length > 0) {
              if (lastWord[lastWord.length - 1] !== i) {
                // 두음법칙
                if (rules.indexOf(_Rule2.default.ALLOWED_INITIAL) !== -1) {
                  if (_Utils2.default.convertInitialSound(lastWord[lastWord.length - 1]) !== i) {
                    check = false;
                  }
                } else {
                  check = false;
...
exports.DictionaryAnalyzer = _DictionaryAnalyzer2.default;
