...
class EasyLevelBehavior extends LevelBehavior {
    constructor() {
        super();
        this.name = 'EasyLevelBehavior';
    }
    ...
    getNextWordFrom(words, history) {
        ...
        for (let word in words) {
            ...
            if (history.indexOf(word) < 0 && score > scoreNew && scoreNew > 40000000) {
                next = word;
                score = scoreNew;
            }
        }
...
module.exports = EasyLevelBehavior;